config =
  default:
    siteUrl: 'https://takumi0125.github.io/simpleGlitch/plane/'
    keywords: 'webgl, threejs, glitch'

    showOGP: true # ogpタグを表示するかどうか

    siteTitle: 'simple glitch transition | simple glitch'
    useTitleAsOgTitle: true # ogTitleをtitleと同じにするかどうか
    ogTitle: ''
    useTitleSeparater: true
    titleSeparater: ' | '

    description: "simple glitch transition I used in previous project."
    useDescriptionAsOgDescription: true # ogDescriptionをdescriptionと同じにするかどうか
    ogDescription: ""

    ogSiteName: 'simple glitch transition | simple glitch'

    ogImage: 'https://takumi0125.github.io/simpleGlitch/assets/img/ogpPlane.png'
